...
namespace TestConsole.Utilities
{
    ...
    {
        //private string i = "320305.131321201";
        public string GetJsMethd(string methodName, object[] para)
        {
            string js = @"
            public static var i = ""320305.131321201"";
            private static function n(r, o) {
...
";
            ...
            //sb.Append(" public static var i='dddd';");
            //sb.Append("     public static function test(str) {");
            //sb.Append("         return 'Hello,'+i+fff(str);");
            //sb.Append("     }");
            //sb.Append("     public static function fff(str) {");
            //sb.Append("         return 'fff Function,'+str;");
            //sb.Append("     }");
